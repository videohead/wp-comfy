...
class Taxonomy extends AbstractAbilityGroup {
	...
	public function register_abilities() {
		...
		$this->register_ability(
			...
			array(
				'label'               => __( 'Register Custom Taxonomy', 'secure-custom-fields' ),
				'description'         => __( 'Register a new taxonomy definition in WordPress (e.g., "Genre", "Color"). This creates the taxonomy schema itself, not individual terms within it. Use the create term abilities to add terms to an existing taxonomy.', 'secure-custom-fields' ),
				'category'            => 'acf-field-management',
				'input_schema'        => array(
					'type'       => 'object',
					'properties' => array(
		...
		foreach ( $acf_taxonomies as $acf_taxonomy ) {
			...
			$this->register_ability(
				...
				array(
					...
					'label'               => sprintf( __( 'Query %s', 'secure-custom-fields' ), $taxonomy_label_plural ),
					/* translators: %s The plural label for the custom taxonomy. */
					'description'         => sprintf( __( 'Get a list of %s terms that match the query parameters.', 'secure-custom-fields' ), strtolower( $taxonomy_label_plural ) ) . $description_suffix,
			...
			$this->register_ability(
				...
				array(
					...
					'label'               => sprintf( __( 'Create %s Term', 'secure-custom-fields' ), $taxonomy_label ),
					/* translators: %s The singular label for the custom taxonomy. */
					'description'         => sprintf( __( 'Create a new "%s" term.', 'secure-custom-fields' ), strtolower( $taxonomy_label ) ) . $description_suffix,
					'category'            => 'wordpress-content-discovery',
			...
			$this->register_ability(
				...
				array(
					/* translators: %s The singular label for the custom taxonomy. */
					'label'               => sprintf( __( 'View a %s Term', 'secure-custom-fields' ), $taxonomy_label ),
					/* translators: %s The singular label for the custom taxonomy. */
					'description'         => sprintf( __( 'Get a %s term by its ID.', 'secure-custom-fields' ), strtolower( $taxonomy_label ) ) . $description_suffix,
					'category'            => 'wordpress-content-discovery',
					'input_schema'        => array(
						'type'       => 'object',
						'properties' => array(
			...
			$this->register_ability(
				...
				array(
					/* translators: %s The singular label for the custom taxonomy. */
					'label'               => sprintf( __( 'Update a %s Term', 'secure-custom-fields' ), $taxonomy_label ),
					/* translators: %s The singular label for the custom taxonomy. */
					'description'         => sprintf( __( 'Update a %s term by its ID.', 'secure-custom-fields' ), strtolower( $taxonomy_label ) ) . $description_suffix,
					'category'            => 'wordpress-content-discovery',
			...
			$this->register_ability(
				...
				array(
					/* translators: %s The singular label for the custom taxonomy. */
					'label'               => sprintf( __( 'Delete a %s Term', 'secure-custom-fields' ), $taxonomy_label ),
					/* translators: %s The singular label for the custom taxonomy. */
					'description'         => sprintf( __( 'Delete a %s term by its ID.', 'secure-custom-fields' ), strtolower( $taxonomy_label ) ) . $description_suffix,
					'category'            => 'wordpress-content-discovery',
					'input_schema'        => array(
						'type'       => 'object',
						'properties' => array(
	...
	public function create_custom_taxonomy( $input ) {
		...
		if ( taxonomy_exists( $taxonomy ) ) {
			return new WP_Error(
				'taxonomy_exists',
				__( 'A taxonomy with this key already exists', 'secure-custom-fields' ),
				array( 'status' => 400 )
			);
		}
		...
		if ( empty( $result['ID'] ) || ! is_int( $result['ID'] ) || ! taxonomy_exists( $result['taxonomy'] ) ) {
			return new WP_Error(
				...
				__( 'Failed to create the custom taxonomy', 'secure-custom-fields' )
			);
		}
